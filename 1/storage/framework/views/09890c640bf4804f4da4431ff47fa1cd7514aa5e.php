                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <div class="alert alert-danger">
                                        <b>Yeah!</b> <?php echo e(session('error')); ?>

                                    </div>
                                    <?php endif; ?>
                                    <?php if(session('username')): ?>
                                    <div class="alert alert-danger">
                                        <b>Opps!</b> <?php echo e(session('username')); ?>

                                    </div>
                                    <?php endif; ?>
                                    <form action="<?php echo e(url('/action-login')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\myFile\Semester 5\Praktek\Framework\tokobuku\resources\views/login.blade.php ENDPATH**/ ?>